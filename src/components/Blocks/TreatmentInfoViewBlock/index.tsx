...
const TreatmentInfoViewBlockComponent: React.FC<Props> = async ({ data, locale }) => {
  ...
  return (
    <div className="min-h-[550px] mb-10 flex items-center justify-center relative py-8 px-2 lg:p-10">
      ...
      <div className="bg-secondary/50 backdrop-blur-md text-secondary-foreground w-full max-w-[600px] py-8 px-3  lg:p-10 rounded-md">
        <h2 className="text-center text-2xl font-medium mb-4">{data.title}</h2>
